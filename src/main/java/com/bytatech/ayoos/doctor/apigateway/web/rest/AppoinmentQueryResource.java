...
import com.bytatech.ayoos.doctor.apigateway.client.appointment.api.AppointmentQueryResourceApi;
import com.bytatech.ayoos.doctor.apigateway.client.appointment.model.OpenAppointmentResponse;
...
public class AppoinmentQueryResource {
	private final Logger log = LoggerFactory.getLogger(AppoinmentQueryResource.class);
	@Autowired
	private AppointmentQueryResourceApi appointmentQueryResourceApi;

	@GetMapping("/open-appoinments")
	   
	    public ResponseEntity<List<OpenAppointmentResponse>> getOpenAppointments(@RequestParam(value = "name", required = false) String name,
